...
```
## Error in fahr_to_celsius(32): could not find function "fahr_to_celsius"
```

```
## Error in fahr_to_celsius(212): could not find function "fahr_to_celsius"
```
...
<img src="02-key-programming-concepts_files/figure-html/unnamed-chunk-79-1.png" width="672" />
...
<img src="02-key-programming-concepts_files/figure-html/unnamed-chunk-80-1.png" width="672" />
